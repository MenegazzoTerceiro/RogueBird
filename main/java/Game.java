...
public class Game implements Runnable {
    ...
    public int coins = 1000; // persistent wallet
    public int ownedSkins = 0; // bitmask of purchased skin IDs
    public int equippedSkin = 0; // 0=none, 1=hat, 2=sunglasses, 3=cape, 4=crown

    public int healthUpgrade = 0; // +vida permanente
    public int shieldUpgrade = 0; // +escudo permanente
    public int damageUpgrade = 0; // +dano permanente
    // ── Loop ───────────────────────────────────────────────────────────────
